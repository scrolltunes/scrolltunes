    ...
    <div className="flex items-center justify-center gap-3 py-4 px-4">
      ...
      {hasIssue && onWarningClick ? (
        ...
        <button
          type="button"
          onClick={onInfoClick}
          className="flex items-center gap-1.5 p-2 rounded-sm text-sm font-medium transition-colors hover:bg-tokyoNight-selection/50"
          style={{
      ...
      <motion.button
        ...
        className="flex items-center justify-center p-2 rounded-sm transition-colors hover:bg-tokyoNight-selection/50"
      ...
      {isAuthenticated && (
        <button
          ...
          className={`relative flex items-center gap-2 rounded-sm transition-colors text-sm font-medium hover:bg-tokyoNight-selection/50 ${
      ...
      {false && isAuthenticated && onEditClick && (
        <button
          type="button"
          onClick={onEditClick}
          className="hidden lg:flex items-center gap-1.5 px-3 py-2 rounded-sm text-sm font-medium transition-colors hover:bg-tokyoNight-selection/50"
          style={{
      ...
      {onShareClick && (
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-2 rounded-sm text-sm font-medium transition-colors hover:bg-tokyoNight-selection/50"
          style={{
            background: "var(--color-surface2)",
            color: "var(--color-text3)",
          }}
