...
|------|-------------|-------------|
| [spec-01](specs/spec-01-normalization-unification.md) | Single-source normalization | Foundation |
| [spec-02](specs/spec-02-topk-candidates.md) | Top-K candidates per key | +2-4% |
| [spec-03](specs/spec-03-multi-artist-verification.md) | Multi-artist scoring | +1-2% |
| [spec-04](specs/spec-04-pop0-fallback-fix.md) | Pop=0 fallback fix | +0.5-1% |
| [spec-05](specs/spec-05-adaptive-duration.md) | Adaptive duration tolerance | +1-2% |
| [spec-06](specs/spec-06-title-first-rescue.md) | Title-first rescue pass | +2-4% |
